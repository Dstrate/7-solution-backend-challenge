...
const (
	BeefService_BeefSummaryService_FullMethodName = "/beef.BeefService/BeefSummaryService"
)
...
type BeefServiceClient interface {
	BeefSummaryService(ctx context.Context, in *BeefSummaryRequest, opts ...grpc.CallOption) (*BeefSummaryResponse, error)
}
...
func (c *beefServiceClient) BeefSummaryService(ctx context.Context, in *BeefSummaryRequest, opts ...grpc.CallOption) (*BeefSummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BeefSummaryResponse)
	err := c.cc.Invoke(ctx, BeefService_BeefSummaryService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BeefServiceServer interface {
	BeefSummaryService(context.Context, *BeefSummaryRequest) (*BeefSummaryResponse, error)
...
func (UnimplementedBeefServiceServer) BeefSummaryService(context.Context, *BeefSummaryRequest) (*BeefSummaryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BeefSummaryService not implemented")
}
...
func _BeefService_BeefSummaryService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BeefSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BeefServiceServer).BeefSummaryService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BeefService_BeefSummaryService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeefServiceServer).BeefSummaryService(ctx, req.(*BeefSummaryRequest))
	}
...
var BeefService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "BeefSummaryService",
			Handler:    _BeefService_BeefSummaryService_Handler,
		},
	},
